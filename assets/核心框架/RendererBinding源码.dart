...
mixin RendererBinding
  ...
  void initInstances() {
    ...
    //注册窗口window的回调
    window
      ..onMetricsChanged = handleMetricsChanged //当系统指标发生变化时调用
      ..onTextScaleFactorChanged =
          handleTextScaleFactorChanged //当平台文字比例系数发生变化时调用
      ..onPlatformBrightnessChanged =
          handlePlatformBrightnessChanged //当平台亮度变化时调用
  ...
  /// 创建一个[RenderView]对象作为[RenderObject]渲染树的根，并初始化它，以便在请求下一帧时进行渲染。
  ///
  /// 当binding被创建后自动调用
  void initRenderView() {
    renderView =
