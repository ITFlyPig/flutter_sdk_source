...
///
/// [RenderCacheSliverList] determines its scroll offset by "dead reckoning" because
/// children outside the visible part of the sliver are not materialized, which
/// means [RenderCacheSliverList] cannot learn their main axis extent. Instead, newly
...
/// zeroth child at a scroll offset other than zero), the [RenderCacheSliverList]
...
/// [RenderSliverFixedExtentList] rather than [RenderCacheSliverList] because
...
class RenderCacheSliverList extends RenderSliverCacheMultiBoxAdaptor {
  /// Creates a sliver that places multiple box children in a linear array along
  /// the main axis.
  ///
  /// The [childManager] argument must not be null.
  RenderCacheSliverList({
  ...
  void performLayout() {
    ...
    // print('constraints.scrollOffset:${constraints.scrollOffset} constraints.cacheOrigin:${constraints.cacheOrigin} scrollOffset:${scrollOffset}');
